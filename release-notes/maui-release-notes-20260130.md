# .NET MAUI Workload Release Notes - January 30, 2026
...
**Workload Set:** [Microsoft.NET.Workloads.9.0.300](https://www.nuget.org/packages/Microsoft.NET.Workloads.9.0.300/9.310.0) version `9.310.0`
...
```bash
# Update existing workloads to this version
dotnet workload update --version 9.0.310

# Or install specific workloads
dotnet workload install maui ios maccatalyst android --version 9.0.310
```
...
- [Microsoft.NET.Workloads.9.0.300](https://www.nuget.org/packages/Microsoft.NET.Workloads.9.0.300/9.310.0) version `9.310.0`
